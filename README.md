...
[CommCare HQ](https://github.com/kabass/commcare-hq-benin/) server environment.
...
* To set up a local development environment for CommCare HQ, view the
  [instructions](https://github.com/kabass/commcare-hq-benin/blob/master/DEV_SETUP.md)
  in that repository.
